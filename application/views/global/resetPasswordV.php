...
<?php $userid = $this->input->cookie('namaUser', TRUE); if ($userid=='') exit('Anda tidak diijikan mengakses halaman ini.'); ?>
<!DOCTYPE html>
...
<head>
<meta charset="utf-8"/>
<title>Microtech | Reset Password</title>
...
<div class="logo" style="color: #ffffff;">
        ...
        <h2>Koperasi Sari Bhakti Bogasari</h2>
