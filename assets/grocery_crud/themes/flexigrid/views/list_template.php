...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="pDiv">
		<div class="pDiv2">
			...
			<div class="pGroup">
				<select name="per_page" id='per_page' class="per_page span1">
			...
			<div class="pGroup">
				<?php echo $this->l('list_page'); ?> <input name='page' type="text" value="1" size="4" id='crud_page' class="crud_page span1">
